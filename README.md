...
1. **Пакеты Разгона**
   ...
   * [4ifir](https://github.com/rashevskyv/4IFIR/) - Пакет разгона от Cooler3D, закрытые исходники (С нарушением лицензий), сомнительная личность автора, который до 4ifir занимался только скам-схемами и криптопирамидами. Зато систему разгона делает отличную, версия 1.7 не считая фейковых частот RAM (+200мгц) работает очень хорошо, а вот 1.8 - сломана, не рекомендуется к использованию никому.
...
* **Отладочная установка** это метод, который следует использовать _только_ тогда, когда понимаете, что делаете, или если об этом вас попросил [компетентный человек](https://t.me/redraz).
